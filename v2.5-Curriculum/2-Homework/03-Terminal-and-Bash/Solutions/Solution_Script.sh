#!/bin/sh
#This script will set up the proper directories and files for the Terminal week homework

#Make sure to chmod this file
#chmod +x ./Solution_Script.sh

#Then run the script to set up Steps 1 and 2
#./Solution_Script.sh

#Removes directories for Step 1
