...
The time tracker for todays lesson can be viewed on Google Drive here: [12.2 Time Tracker](https://docs.google.com/spreadsheets/d/17TOcblJ-vKhVVMslUKDHU7BGGMb26qsDKBZ-KoA_axI/edit#gid=1145703143)
...
- Display the following diagram to students and describe how the application components talk to one another:
  ...
  ![A diagram depicts the flow of information among components of an application.](./Images/12.2-information-flows.png)
...
It isn't absolutely crucial for students to understand in-depth how a YAML file is constructed. But, they will examine and edit one for their activity, so they will need to know where to find certain configurations.
...
:warning: **Heads Up**: This demo, activity, and review contain important concepts that will be built upon in the upcoming Web Vulnerability module. 
...
Summarize that this week's module showed students how web applications are intended to be used, while our upcoming module, Web Vulnerabilities, will show how to use web applications in ways that were not intended.
...
-  Explain that for the upcoming Cloud Security and Project Week modules, students will need their own individual Azure accounts. They will **not** use the cyberxsecurity accounts. 
   ...
   - Make sure all students are setup prior to the next class. 
