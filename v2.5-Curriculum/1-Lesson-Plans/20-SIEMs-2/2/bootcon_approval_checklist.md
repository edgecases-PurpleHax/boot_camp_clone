...
- [ ] The project proposal falls under one of the following three categories:
    ...
    - Developing code/a program that can complete a cybersecurity task; OR
    - Demonstration of a cybersecurity tool not covered in the class to accomplish a specific goal.
- [ ] No aspect of the project proposal may be considered illegal or unethical. Specifically:
    - All hacks/tests must be conducted in simulated environments.
