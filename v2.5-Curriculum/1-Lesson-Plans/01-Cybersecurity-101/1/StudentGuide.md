...
#### Course Structure <!-- @CE v2.5 updates needed for this section -->
...
**Unit 6**: Review and Final Projects (Modules 22-24)
...
#### Example Assignments <!-- @CE Verify/update bullets in this section for v2.5 -->
...
#### Projects <!-- @CE v2.5 updates needed for this section -->
