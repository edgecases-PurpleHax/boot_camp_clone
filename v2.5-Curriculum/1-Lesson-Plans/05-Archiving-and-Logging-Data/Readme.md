...
This module will continue to use the local Vagrant virtual machine we used in the previous module. Please make sure to update to the latest build before starting this module.
...
- [Challenge Assignment File](../../2-Homework/05-Archiving-and-Logging-Data/Readme.md)
