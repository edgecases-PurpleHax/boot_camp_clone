...
2. Working in your group's copy of the report template, add content and details as indicated in each section.
 ...
 - Each student must submit an individual copy of the completed Final Case Report document.
...
Below are the files required to complete the assignment:
   ...
   - [Google Sheets: Russian Tea Room](https://docs.google.com/spreadsheets/d/1GeibalvCi0jnUKay82dSne9V9kdEuUNyOxpaAEBABiU/edit#gid=0)
...
1. Launch Autopsy and select **Open Case**.
   ...
   - Open the `RussianTeaRoom` folder and select `RussianTeaRoom.aut`.
    ...
    - Add the `Russian-TeaRoom.E01` EnCase image file to the case.

   - This is a sample of the hex data in the Autopsy `RussianTeaRoom` case file:

     ![Images/hex-data.png](Images/hex-data.png)

2. Use [Google Sheets: Russian Tea Room](https://docs.google.com/spreadsheets/d/1GeibalvCi0jnUKay82dSne9V9kdEuUNyOxpaAEBABiU/edit#gid=0) to document the remaining information from the EnCase image for the investigation.
...
- Submit the completed [Google Sheets: Russian Tea Room](https://docs.google.com/spreadsheets/d/1GeibalvCi0jnUKay82dSne9V9kdEuUNyOxpaAEBABiU/edit#gid=0)  file.
