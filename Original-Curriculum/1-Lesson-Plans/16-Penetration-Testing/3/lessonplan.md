...
In today's class, we will use the Kali machine and the Shellshock machine
...
### 05. Student Do: SearchSploit and Shellshock (0:20)
...
Take some time to review the new flags and quiz concepts as a class. 
