...
Like many certifications in the infosec field, most of the training for these certifications are expensive. Many of them cost over $2,000.
...
You can independently complete any remaining trainings to obtain the **Splunk Core Certified User Certification**.
  ...
  - Refer to the following [link](https://www.splunk.com/en_us/training/certification-track/splunk-core-certified-user.html) if you are interested in learning the requirements for obtaining the **Splunk Core Certifed User Certification**.  
...
### 06. Continuing Your Splunk Education (1:00)
